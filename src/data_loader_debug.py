...
def load_wallet_graph_combined_debug(data_dir):
    ...
    # 🧪 DEBUG: Welche Spalten sind im DataFrame?
    print("📋 Alle Spalten im DataFrame:", df.columns.tolist())
    print("🔍 Erste Zeilen:")
    print(df.head())

    # 🧪 DEBUG: Welche Spalten gehen wirklich in x ein?
    feature_columns = df.drop(columns=['address', 'class', 'node_id']).columns.tolist()
    print("✅ Verwendete Feature-Spalten:", feature_columns)

    # Extrahiere Features als Tensor
